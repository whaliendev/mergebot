...
TEST(Similarity, CosineSimilarity) {
  std::string s1 = R"(class DBImpl : public DB {
public:
 ...
 virtual Env* GetEnv() const;class DBImpl : public DB {
public:
 DBImpl(const DBOptions& options, const std::string& dbname);
 virtual ~DBImpl();
...
private:
 ...
 Status GetImpl(const ReadOptions& options, ColumnFamilyHandle* column_family,
  ...
  std::string s2 =
      R"(// Modules in this directory should keep internal keys wrapped inside
...
class InternalKey {
 ...
 public:
  ...
  double similarity = mergebot::util::string_cosine(s1, s2, 3);

  EXPECT_TRUE(similarity > 0);
  spdlog::info("Cosine similarity: {}", similarity);
}
...
class InternalKey {
 ...
 public:
  ...
  double similarity = mergebot::util::string_levenshtein(s1, s2);
