...
#ifndef MERGEBOT_SET_H
#define MERGEBOT_SET_H
...
#pragma clang diagnostic pop
  ...
  Set<T> &operator+=(const Set<T> &other) { return unite(other); }
  ...
  Set<T> &operator+=(const List<T> &other) { return unite(other); }

  Set<T> &operator<<(const T &t) {
    insert(t);
    return *this;
  }
  Set<T> &operator<<(const List<T> &t) { return unite(t); }

  Set<T> &operator<<(const Set<T> &t) { return unite(t); }
...
#pragma clang diagnostic pop
  ...
  typename Base::const_iterator constEnd() const { return Base::end(); }
