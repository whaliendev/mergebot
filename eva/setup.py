...
setup(
    ...
    description="An octo Swiss army knife",  # Optional
    ...
    install_requires=[
        ...
        "caio==0.9.13; python_version >= '3.7' and python_version < '4'",
        "cerberus==1.3.5",
        ...
        "distlib==0.3.7",
        "dnspython==2.4.2; python_version >= '3.8' and python_version < '4'",
        ...
        "pipenv-setup @ git+https://github.com/Madoshakalaka/pipenv-setup@109056e7b33b2ae4242eb56326c4f9bc66dde841",
        "pipfile==0.0.2",
